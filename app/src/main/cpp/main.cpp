...
static void handle_cmd(android_app* app, int32_t cmd) {
    switch (cmd) {
        case APP_CMD_INIT_WINDOW:  LOGI("Window ready"); break;
        case APP_CMD_TERM_WINDOW:  LOGI("Window destroyed"); break;
        case APP_CMD_DESTROY:      LOGI("App destroy requested"); break;
        default: break;
    }
}
